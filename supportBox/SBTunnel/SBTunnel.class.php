...
command                 = autossh -p80 -M0 -N -o ExitOnForwardFailure=yes -o ServerAliveInterval=15 -o ServerAliveCountMax=4 -o ControlPath=none -oStrictHostKeyChecking=no -R".$this->A("SBTunnelServerPort").":".$this->A("SBTunnelIP").":".$this->A("SBTunnelPort")." $cloudID@static01.supportbox.io
